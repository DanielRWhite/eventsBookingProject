...
(function ($, window, document, undefined) {
  ...
  */
  ...
  for(; lastTime < libs.length && !requestAnimationFrame; lastTime++) {
    requestAnimationFrame = window[ libs[lastTime] + "RequestAnimationFrame" ];
    cancelAnimationFrame = cancelAnimationFrame ||
      window[ libs[lastTime] + "CancelAnimationFrame" ] || 
      window[ libs[lastTime] + "CancelRequestAnimationFrame" ];
  }
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // libs had inconsistent prefixing with the experimental Indexed DB:
